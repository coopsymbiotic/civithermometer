 ...
 */
class CRM_Civithermometer_Upgrader_Base {

  /**
   * @var CRM_Civithermometer_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Civithermometer_Upgrader(
        'civithermometer',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Civithermometer_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Civithermometer_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
